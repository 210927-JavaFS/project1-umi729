...
public class Test {
	...
	public static void main(String[] args) {
		...
		userSer.addUser(new UserClass(1,"manager", "mypassword", "Umer", "Zahid", "umi729@gmail.com", ur));
		userSer.addUser(new UserClass(2, "employee", "mypassword", "Sam", "Zirbel", "u9@gmail.com", em));
